      ...
      <Container>
        ...
        <div className={css(styles.processContainer)}>
          ...
          <div className={css(styles.processCardContainer)}>
            <ProcessCard heading="Find recipe" subHeading="Our vast database is guaranteed to contain all of your favorite recipes." />
            <ProcessCard heading="Get a grocery list" subHeading="We generate grocery lists based on your recipe selections." />
            <ProcessCard heading="Shop" subHeading="Use our integrations to get groceries delivered to your door." />
          </div>
        </div>
      </Container>
    </div>
